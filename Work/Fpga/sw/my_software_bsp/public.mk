...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../compression.sopcinfo
...
# Design Name 
# setting SOPC_NAME is compression
SOPC_NAME := compression
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2081230
SOPC_SYSID_FLAG += --sidp=0x2081230
ELF_PATCH_FLAG  += --sidp 0x2081230

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1556863269
SOPC_SYSID_FLAG += --timestamp=1556863269
ELF_PATCH_FLAG  += --timestamp 1556863269
